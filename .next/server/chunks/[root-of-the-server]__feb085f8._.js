...
"[project]/lib/mqttClient.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function getMqttClient() {
    if (!client) {
        client = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mqtt$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].connect("wss://broker.emqx.io:8084/mqtt");
        client.on("connect", ()=>{
...
"[project]/utils/mqttTopic.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mqttClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/mqttClient.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/mqttTopic.ts [app-route] (ecmascript)");
;
;
;
;
...
async function PATCH(req, { params }) {
    ...
    try {
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.findUnique({
            where: {
                id: orderId
            }
        });
        ...
        if (status) {
            if (status === "READY") {
                ...
                const isDone = order.completedAt !== null || data.completedAt !== undefined;
                if (!isDone) {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.update({
            where: {
                id: orderId
            },
            data
        ...
        if (status === "READY" || status === "COMPLETED") {
            const mqtt = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mqttClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMqttClient"])();
            const topic = status === "READY" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getKitchenReadyOrderTopic"])(order.customerId) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStaffCompletedOrderTopic"])(order.customerId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__feb085f8._.js.map
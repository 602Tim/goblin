...
"[project]/.next-internal/server/app/api/menu/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/menu/[id]/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PUT(req, { params }) {
    try {
        ...
        if (!name || price === undefined) {
            return new Response("缺少必要欄位", {
                status: 400
            });
        }
        const updatedItem = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].menuItem.update({
            where: {
                id: id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa7b3547._.js.map
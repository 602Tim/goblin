...
"[project]/.next-internal/server/app/api/image/upload/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/image/upload/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!imageUrl) {
            return new Response("缺少圖片網址", {
                status: 400
            });
        }
        // 儲存圖片資料到資料庫（如果有圖片表）
        const saved = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].image.create({
            data: {
                url: imageUrl,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5d10541._.js.map
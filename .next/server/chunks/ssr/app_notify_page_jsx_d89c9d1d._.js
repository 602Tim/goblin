...
"[project]/app/notify/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useNotifications$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useNotifications.js [app-ssr] (ecmascript)");
"use client";
;
;
;
;
function NotifyPage() {
    const { notifications, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useNotifications$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
    const getIcon = (type)=>{
        switch(type){
            case "order":
                return "🍱";
...
//# sourceMappingURL=app_notify_page_jsx_d89c9d1d._.js.map
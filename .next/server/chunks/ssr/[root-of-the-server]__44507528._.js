...
"[project]/app/actions/data:b6415a [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$b6415a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:b6415a [app-ssr] (ecmascript) <text/javascript>");
...
function useNotifications(userId) {
    ...
    const fetchNotifications = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            // action
            let data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$b6415a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getUserNotification"])(userId);
            if (!data) {
                // api (作為備用或主要方式)
...
"[project]/app/actions/data:4917ca [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$4917ca__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:4917ca [app-ssr] (ecmascript) <text/javascript>"); // 保持這行
"use client";
;
;
;
...
function NotifyButton({ userId }) {
    ...
    const handleDeleteNotification = async (nId)=>{
        ...
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$4917ca__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteNotification"])(nId); // 這是 Server Action
            if (!data || data.error) {
...
"[project]/app/components/sessionNavbar.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/components/authSessionProvider.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/components/RouteEvents.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__44507528._.js.map
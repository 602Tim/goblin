...
"[project]/app/orders/pending/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PendingOrdersPage() {
    ...
    const { messages, publishMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useMqttClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMqttClient"])({
        subscribeTopics: [
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOrderCheckoutTopic"])(),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCustomerCancelOrderTopic"])("#")
        ]
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const getOrders = async ()=>{
            try {
                let data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$order$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPendingOrders"])();
                if (!data) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const isCheckoutOrder = topic === (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOrderCheckoutTopic"])();
        const isCancelOrder = topic.startsWith((0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCustomerCancelOrderTopic"])(""));
        if (isCheckoutOrder) {
            try {
                const newOrder = JSON.parse(lastMessage.payload);
                setOrders((prev)=>prev.some((order)=>order.id === newOrder.id) ? prev : [
                        {
                            ...newOrder,
                            uiAccepted: false
                        },
    ...
    const handleAcceptOrder = async (orderId)=>{
        ...
        try {
            ...
            const notificationRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$f65a60__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addNotification"])({
                orderId,
                message
            }, customerId);
            if (!notificationRes) throw new Error("傳送通知失敗");
            const notifyTopic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNotificationTopicByUserId"])(customerId);
            publishMessage(notifyTopic, JSON.stringify({
                notificationId: notificationRes.id,
                message
            }));
            const kitchenTopic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOrderToKitchenTopic"])();
    ...
    const handleConfirmPayment = async (orderId)=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$order$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["editOrderStatus"])({
                paymentStatus: true
            }, orderId);
            ...
            if (!notificationRes) throw new Error("傳送通知失敗");
            const topic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNotificationTopicByUserId"])(customerId);
    ...
    const handleDeleteOrder = async (orderId, customerId)=>{
        try {
            ...
            const notifyRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$f65a60__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addNotification"])({
                orderId,
                message
            }, customerId);
            if (notifyRes) {
...
//# sourceMappingURL=app_8bfbd3cf._.js.map
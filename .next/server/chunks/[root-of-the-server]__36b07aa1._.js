...
"[project]/.next-internal/server/app/api/users/[id]/role/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function PATCH(req, { params }) {
    try {
        ...
        if (!userId) {
            return new Response("缺少 userId", {
                status: 400
            });
        }
        const { role } = await req.json();
        if (!role) {
            return new Response("缺少 role 欄位", {
                status: 400
            });
        }
        // 不允許更改 OWNER 權限（視你的需求）
        if (role === "OWNER") {
            return new Response("不能更改為 OWNER", {
                status: 403
            });
        }
        // 更新使用者角色
...
//# sourceMappingURL=%5Broot-of-the-server%5D__36b07aa1._.js.map
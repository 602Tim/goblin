...
"[project]/app/orders/ready/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ReadyOrdersPage() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const { user, loading: userLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useUser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReadyOrdersPage.useEffect": ()=>{
            if (userLoading) {
                return;
            }
            setTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getKitchenReadyOrderTopic"])("#"));
            const getOrders = {
                "ReadyOrdersPage.useEffect.getOrders": async ()=>{
                    try {
                        // action
                        let data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$order$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReadyOrders"])();
                        if (!data) {
                            // api
            ...
            }["ReadyOrdersPage.useEffect.getOrders"];
            getOrders();
        }
    }["ReadyOrdersPage.useEffect"], [
        userLoading
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReadyOrdersPage.useEffect": ()=>{
            ...
            try {
                ...
                setOrders({
                    "ReadyOrdersPage.useEffect": (prev)=>{
                        // 檢查是否已存在相同 ID 的訂單
                        const exists = prev.some({
                            "ReadyOrdersPage.useEffect.exists": (order)=>order.id === newOrder.id
                        }["ReadyOrdersPage.useEffect.exists"]);
                        return exists ? prev : [
                            ...prev,
                            {
                                ...newOrder,
    ...
    const handleCompleteButton = async (orderId)=>{
        ...
        // 取得完整訂單資料（用於通知顧客）
        let orderData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$order$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrderById"])(orderId);
        if (!orderData) {
            const orderRes = await fetch(`/api/order/${orderId}`);
            if (!orderRes.ok) {
                alert("獲取訂單詳情失敗");
        ...
        const topic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCustomerOrderUpdateTopic"])(customerId); // 顧客專屬更新主題
...
_s(ReadyOrdersPage, "jzXoJFEYuwpjbjpkuJjUzGtkAKU=", false, function() {
    return [
...
_c = ReadyOrdersPage;
var _c;
__turbopack_context__.k.register(_c, "ReadyOrdersPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_0c5da52e._.js.map
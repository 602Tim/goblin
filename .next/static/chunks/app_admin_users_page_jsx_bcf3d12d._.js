...
function AdminUsersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminUsersPage.useEffect": ()=>{
            const getUsers = {
                "AdminUsersPage.useEffect.getUsers": async ()=>{
                    ...
                    const formedData = data.map({
                        "AdminUsersPage.useEffect.getUsers.formedData": (item)=>({
                                id: item.id,
                                email: item.email,
                                role: item.role,
                                name: item.name,
                    ...
                    }["AdminUsersPage.useEffect.getUsers.formedData"]);
                    setUsers(formedData);
                    setLoading(false);
                }
            }["AdminUsersPage.useEffect.getUsers"];
            getUsers();
        }
    }["AdminUsersPage.useEffect"], []);
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        Object.entries(roleLabels).filter(([key])=>key !== "OWNER" && key !== user.role).map(([key, label])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: key,
                                                children: label
                                            }, key, false, {
                                                fileName: "[project]/app/admin/users/page.jsx",
...
//# sourceMappingURL=app_admin_users_page_jsx_bcf3d12d._.js.map
...
"[project]/lib/mqttClient.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function getMqttClient() {
    if (!client) {
        client = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mqtt$2f$dist$2f$mqtt$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].connect("wss://broker.emqx.io:8084/mqtt", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mqttClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/mqttClient.js [app-client] (ecmascript)");
...
function CheckoutPage() {
    ...
    const [statusLog, setStatusLog] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CheckoutPage.useEffect": ()=>{
            ...
            const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mqttClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMqttClient"])();
            const statusTopic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrderStatusWildcardTopic"])(session.user.id);
            const handleMessage = {
                "CheckoutPage.useEffect.handleMessage": (t, message)=>{
                    try {
                        const payload = JSON.parse(message.toString());
                        console.log("📥 MQTT 訂單狀態更新:", payload);
                        setStatusLog({
                            "CheckoutPage.useEffect.handleMessage": (prev)=>[
                                    ...prev,
                                    payload
                                ]
                        }["CheckoutPage.useEffect.handleMessage"]);
                    } catch (err) {
        ...
        children: [
            ...
            cart.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    statusLog.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                ...
                                children: statusLog.map((log, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        children: [
                                            log.status,
                                            "（",
...
_s(CheckoutPage, "SQr+2uwjFY21X/J61daL22h7XEs=", false, function() {
    return [
...
//# sourceMappingURL=_a18d517d._.js.map
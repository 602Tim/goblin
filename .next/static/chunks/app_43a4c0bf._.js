...
"[project]/app/kitchen/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function KitchenPage() {
    ...
    const topic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "KitchenPage.useMemo[topic]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$mqttTopic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getKitchenOrderTopic"])()
    }["KitchenPage.useMemo[topic]"], []);
        ...
        "KitchenPage.useEffect": ()=>{
            const fetchOrders = {
                "KitchenPage.useEffect.fetchOrders": async ()=>{
                    try {
                        let data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$order$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getKitchenOrders"])();
                        if (!data) {
                            alert("取得廚房訂單失敗");
                            return;
                        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "KitchenPage.useEffect": ()=>{
            ...
            try {
                ...
                setOrders({
                    "KitchenPage.useEffect": (prev)=>{
                        const exists = prev.some({
                            "KitchenPage.useEffect.exists": (order)=>order.id === newOrder.id
                        }["KitchenPage.useEffect.exists"]);
                        return exists ? prev : [
                            ...prev,
                            newOrder
                        ];
    ...
    const handleCompleteOrder = async (orderId)=>{
        try {
            ...
            const completeRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$order$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editOrderCompletion"])(orderId);
            if (!completeRes) {
                alert("❌ 標記完成失敗！");
                return;
            }
            ...
            let notificationRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$f65a60__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addNotification"])({
                orderId,
                message
            }, customerId);
            if (!notificationRes) {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                    ...
                                    children: order.items.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            children: [
                                                ...
                                                item.specialRequest && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(KitchenPage, "nUW0vdApnEs2c9/p/kgIybAeFNk=", false, function() {
    return [
...
//# sourceMappingURL=app_43a4c0bf._.js.map